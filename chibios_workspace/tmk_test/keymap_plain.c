...
const uint8_t keymaps[][5][25] = {
 /* 0: Qwerty
     ...
     KEYMAP(NLCK, F12, F11, F10, ESC, GRV, 1,   2,   3,   4,   5, PSCR, SLCK, BRK,  6, 7, 8 , 9, 0, MINS, EQL, NLCK, PSLS, PAST, PMNS,
            ...
            PDOT, PDOT, LCTL, LGUI, NO, LALT, SPC, LEFT, DOWN, RIGHT, ENT, RALT, RGUI, RCTRL, BSPC, P0, PDOT,
            NO, NO),
     ...
     KEYMAP(TRNS, TRNS, TRNS, TRNS, ESC, TRNS, F1,  F2, F3, F4, F5, TRNS, TRNS, TRNS, F6, F7, F8 , F9, F10, F11, F12, TRNS, TRNS, TRNS, BSPC,
           ...
           TRNS, DEL, TRNS, TRNS, TRNS, TRNS, BSPC, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, DEL, ESC, TRNS,
           NO, NO),

     KEYMAP(TRNS, TRNS, TRNS, TRNS, ESC, TRNS, F1,  F2, F3, F4, F5, TRNS, TRNS, TRNS, F6, F7, F8 , F9, F10, F11, F12, TRNS, TRNS, TRNS, TRNS,
            TRNS, 9, 8, 7, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, HOME, UP, END, PGUP, TRNS, TRNS, P7, P8, P9, PPLS,
            6, 5, 4, FN0, FN1, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, LEFT, DOWN, RIGHT, PGDN, TRNS,  TRNS, TRNS, TRNS, TRNS,
            TRNS, 3, 2, 1, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,
            TRNS, DEL, TRNS, TRNS, TRNS, TRNS, DEL, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, DEL, TRNS, TRNS, TRNS,
            NO, NO)
};
