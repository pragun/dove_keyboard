...
const uint8_t keymaps[][5][25] = {
  ...
  * as on 4/4/2021
     ...
     KEYMAP(NLCK, F12, F11, F10, ESC, GRV, 1,   2,   3,   4,   5, PSCR, SLCK, BRK,  6, 7, 8 , 9, 0, MINS, EQL, NLCK, PSLS, PAST, PMNS,
            ...
            F6, F5, F4, FN6, FN7, A, S, D, F, G, DEL, END, PGDN, H, J, K, L, SCLN, QUOT, BSLS, P4, P5, P6,
            PENT, F3, F2, F1, FN4, Z, X, C, V, B, UP, N, M, COMM, DOT, SLSH, FN5, P1, P2, P3, PENT,
            PDOT, PDOT, LCTL, LGUI, NO, LALT, FN2, LEFT, DOWN, RIGHT, FN3, DEL, FN0, FN1, ENT, P0, PDOT,
            NO, NO),

     KEYMAP(TRNS, TRNS, TRNS, TRNS, ESC, TRNS, F1,  F2, F3, F4, F5, TRNS, TRNS, TRNS, F6, F7, F8 , F9, F10, F11, F12, TRNS, TRNS, TRNS, BSPC,
            TRNS, 9, 8, 7, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, HOME, UP, END, PGUP, TRNS, TRNS, HOME, UP, PGUP, DEL,
            6, 5, 4, FN0, FN1, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, LEFT, DOWN, RIGHT, PGDN, TRNS,  TRNS, LEFT, ENT, RIGHT,
...
const action_t fn_actions[] = {
   ...
   ACTION_MODS_TAP_KEY(MOD_RSFT, KC_BSPC),
   ACTION_MODS_TAP_KEY(MOD_LSFT, KC_ENT),
